<template>
  <div class="app-container">
          ...
          >
            <template slot-scope="scope" v-if="scope.row.userId !== 1">
              ...
              <el-dropdown  @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['system:user:resetPwd', 'system:user:edit']">
                <el-button  type="text" icon="el-icon-d-arrow-right" size="mini">更多</el-button>
    ...
    <!-- 用户导入对话框 -->
    <el-dialog  center :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body>
      <el-upload
        ref="upload"
        :limit="1"
        accept=".xlsx, .xls"

<template>
  <div class="app-container">
    ...
    <el-dialog  center title="Cron表达式生成器" :visible.sync="openCron" append-to-body destroy-on-close class="scrollbar">
      <crontab @hide="openCron=false" @fill="crontabFill" :expression="expression"></crontab>
    </el-dialog>

    <!-- 任务日志详细 -->
    <el-dialog  center title="任务详细" :visible.sync="openView" width="700px" append-to-body>
